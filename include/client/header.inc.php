<?php
$title=($cfg && is_object($cfg) && $cfg->getTitle())?$cfg->getTitle():'GetTaxi NYC Support Center';
...
<head>
    ...
    <script src="<?php echo ROOT_PATH; ?>js/jquery-ui-timepicker.js"></script>
...
<body>
    <div id="container">
        <div id="header">
            <a id="logo" href="<?php echo ROOT_PATH; ?>index.php" title="GetTaxi NYC Support Center"><img src="<?php echo ASSETS_PATH; ?>images/logo.png" border=0 alt="Support Center"></a>
            <p>
             <?php
