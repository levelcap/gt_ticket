...
<form action="tickets.php?a=open" method="post" id="save"  enctype="multipart/form-data">
 ...
 <table class="form_table" width="940" border="0" cellspacing="0" cellpadding="2">
    ...
    <tbody>
        ...
        <tr>
            <td width="160">Driver ID:</td>
            <td>
                <input type="text" size="50" name="driver_id" id="driver_id">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['driver_id']; ?></span>
            </td>
        </tr>
        <tr>
            <td width="160">
        ...
        <tr>
            ...
            <td>
                <select id="is_booking" name="is_booking" onchange="ChangeDropdowns();">
                    <option value="" <?php if($info['is_booking'] == "") echo 'selected="selected"'; ?>>&mdash; Select Ticket Type &mdash;</option>
                    <option value="0" <?php if($info['is_booking'] == "0") echo 'selected="selected"'; ?>>Non-Booking</option>
                    <option value="1" <?php if($info['is_booking'] == "1") echo 'selected="selected"'; ?>>Future Booking</option>
                </select>
                &nbsp;<font class="error">*&nbsp;<?php echo $errors['is_booking']; ?></font>
            </td>
        </tr>
        <tr class="booking" style="display: none">
            <td width="160">Booking Type:</td>
            <td>
                <select id="booking_type" name="booking_type" onchange="ChangeDropdowns();">
                    <option value="" <?php if($info['booking_type'] == "") echo 'selected="selected"'; ?>>&mdash; Select Booking Type &mdash;</option>
        ...
        <tr class="booking" style="display: none">
            <td width="160">Pickup date and time:</td>
            <td>
                <input type="text" size="50" name="pickup_datetime" id="datetimeicker" value="<?php echo $info['pickup_datetime']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['pickup_datetime']; ?></span>
            </td>
        </tr>
        <tr class="booking" style="display: none">
            <td width="160">Pickup address:</td>
            <td>
                <input type="text" size="50" name="pickup_address" id="pickup_address" value="<?php echo $info['pickup_address']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['pickup_address']; ?></span>
            </td>
        </tr>
        <tr class="airport" style="display: none">
            <td width="160">Airport Terminal:</td>
            <td>
                <input type="text" size="50" name="airport_terminal" id="airport_terminal" value="<?php echo $info['airport_terminal']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['airport_terminal']; ?></span>
            </td>
        </tr>
        <tr class="airport" style="display: none">
            <td width="160">Airport Airline:</td>
            <td>
                <input type="text" size="50" name="airport_airline" id="airport_airline" value="<?php echo $info['airport_airline']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['airport_airline']; ?></span>
            </td>
        </tr>
        <tr class="airport" style="display: none">
            <td width="160">Airport Flight Number:</td>
            <td>
                <input type="text" size="50" name="airport_flight_number" id="airport_flight_number" value="<?php echo $info['airport_flight_number']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['airport_flight_number']; ?></span>
            </td>
        </tr>
        <tr class="airport" style="display: none">
            <td width="160">Airport Dest/Orig:</td>
            <td>
                <input type="text" size="50" name="airport_dest_orig" id="airport_dest_orig" value="<?php echo $info['airport_dest_orig']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['airport_dest_orig']; ?></span>
            </td>
        </tr>
        <tr class="booking" style="display: none">
            <td width="160">Destination:</td>
            <td>
                <input type="text" size="50" name="destination" id="destination" value="<?php echo $info['destination']; ?>">
                &nbsp;<span class="error">*&nbsp;<?php echo $errors['destination']; ?></span>
            </td>
        </tr>
        <tr>
            <th colspan="2">
...
<script type="text/javascript">
    function ChangeDropdowns(){
        var selection1 = document.getElementById("is_booking");
        var selection2 = document.getElementById("booking_type");
        if(selection1.options[selection1.selectedIndex].value == "0" || selection1.options[selection1.selectedIndex].value == ""){
            var rows = document.getElementsByClassName("booking");
            for(var i = 0; i < rows.length; i = i + 1) {
                rows[i].style.display="none";
            }
        }else if(selection1.options[selection1.selectedIndex].value == "1"){
            var rows = document.getElementsByClassName("booking");
            for(var i = 0; i < rows.length; i = i + 1) {
                rows[i].style.display="table-row";
            }
        }
        if(selection2.options[selection2.selectedIndex].value == "general" || selection2.options[selection2.selectedIndex].value == ""){
            var rows = document.getElementsByClassName("airport");
            for(var i = 0; i < rows.length; i = i + 1) {
                rows[i].style.display="none";
            }
        }else if(selection2.options[selection2.selectedIndex].value == "airport"){
            var rows = document.getElementsByClassName("airport");
            for(var i = 0; i < rows.length; i = i + 1) {
                rows[i].style.display="table-row";
            }
