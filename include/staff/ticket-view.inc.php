    ...
    <tr>
        ...
        <td width="50%">
            <table border="0" cellspacing="" cellpadding="4" width="100%">
                ...
                <tr>
                    <th width="100">Driver ID:</th>
                    <td><?php echo $ticket->getDriverID(); ?></td>
                </tr>
                <tr>
                    <th>Phone:</th>
...
<table class="ticket_info" cellspacing="0" cellpadding="0" width="940" border="0">
    <tr>
        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100">Pickup date and time:</th>
                    <td><?php echo $ticket->getPickupDatetime(); ?></td>
                </tr>
                <tr>
                    <th>Pickup address:</th>
                    <td><?php echo $ticket->getPickupAddress(); ?></td>
                </tr>
                <tr>
                    <th>Destination:</th>
                    <td><?php echo $ticket->getDestination(); ?></td>
                </tr>
                <tr>
                    <th>Booking type:</th>
                    <td><?php
                        switch ($ticket->getBookingType()) {
                            case 'airport':
                                echo 'Airport booking';
                                break;
                            case 'general':
                                echo 'General booking';
                                break;
                        }
                     ?></td>
                </tr>
        ...
        <?php if ($ticket->getBookingType() == 'airport') { ?>

        <td width="50%">
            <table cellspacing="0" cellpadding="4" width="100%" border="0">
                <tr>
                    <th width="100">Terminal:</th>
                    <td><?php echo $ticket->getAirportTerminal(); ?></td>
                </tr>
                <tr>
                    <th nowrap>Airline:</th>
                    <td><?php echo $ticket->getAirportAirline(); ?></td>
                </tr>
                <tr>
                    <th nowrap>Flight number:</th>
                    <td><?php echo $ticket->getAirportFlightNumber(); ?></td>
                </tr>
                <tr>
                    <th nowrap>Flight destination/origin:</th>
                    <td><?php echo  $ticket->getAirportDestOrig(); ?></td>
                </tr>
            </table>
        </td>
