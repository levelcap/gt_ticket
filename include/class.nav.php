...
class UserNav {
    ...
    function getNavLinks(){
        ...
        if(!$this->navs){
            ...
            $navs['booking']=array('desc'=>'Book&nbsp;a&nbsp;Future&nbsp;Ride','href'=>'booking.php','title'=>'');
            ...
            $navs['complaint']=array('desc'=>'Driver&nbsp;Complaint&nbsp;Form','href'=>'driver_complaint.php','title'=>'Driver Complaint Form'); 
            $this->navs=$navs;
        }
