...
$inc='dr_open.inc.php';    //default include.
...
if($_POST):
    ...
    if($thisclient) {
        $vars['Order']=$thisclient->getOrder();
        $vars['DrName']=$thisclient->getDriverName();
        $vars['PassengerName']=$thisclient->getPassengerName();
